...
class InputForm(forms.Form):
    ...
    buyer_firm=forms.CharField(label='Buyers Address', max_length=100, required=False)
    buyer_phone=forms.CharField(label='Buyer Phone', max_length=100, required=False)
    buyer_email=forms.CharField(label='Buyer Email', max_length=100, required=False)
    seller=forms.CharField(label='Seller', max_length=100, required=False)
    seller_firm= forms.CharField(label='Seller Address', max_length=100, required=False)
    seller_phone=forms.CharField(label='Seller Phone', max_length=100, required=False)
    seller_email=forms.CharField(label='Seller Email', max_length=100, required=False)
    property=forms.CharField(label='Property Address', max_length=100, required=False)
    lot_no=forms.CharField(label='Tax Map No.', max_length=100, required=False)
    ...
    attorney_email=forms.CharField(label='Attorney Email', max_length=100, required=False)
    ...
    lender_email=forms.CharField(label='Lender Email', max_length=100, required=False)
    ...
    broker_email=forms.CharField(label='Broker Email', max_length=100, required=False)
    sellers_broker=forms.CharField(label='Broker', max_length=100, required=False)
    sellers_broker_firm=forms.CharField(label='Broker Firm', max_length=100, required=False)
    sellers_broker_phone=forms.CharField(label='Broker Phone', max_length=100, required=False)
    sellers_broker_email=forms.CharField(label='Broker Email', max_length=100, required=False)
